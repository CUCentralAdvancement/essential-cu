    ...
    <Layout>
      <Section type="1-col">
        ...
        <div className={"md:max-w-screen-lg mx-auto text-center"}>
          <h1 className={"py-4 text-28 lg:text-50"}>When you invest in CU, your impact is mighty</h1>
          <p className={"text-xl lg:text-lg py-3"}>
            ...
            return (
              <Link key={index}
                ...
                <a className={"bg-blue-900"}>
                  <div className="flex flex-col justify-end h-full rounded-lg bg-cover pt-44 md:pt-64"
                    ...
                    <span className="px-6 py-3 font-bold bg-white text-xl lg:w-1/2 lg:rounded-tr-lg">{cards[el].title}</span>
      ...
      <div className="lg:max-w-screen-lg space-y-4 text-center grid grid-cols-1 p-4 lg:mx-auto place-items-center">
        <Image src="/assets/ir21/circles-pic.png" alt="The Image"/>
        <h3 className={"text-28 lg:text-38"}>352.2 million given last year</h3>
        <p>
      ...
      <div className={"container space-x-0 space-y-4 lg:space-x-4 lg:space-y-0 text-center " +
            "grid grid-cols-1 lg:grid-cols-2 p-4 place-items-center lg:mx-auto"}>
          <p className={"text-28 lg:text-38 order-2 lg:order-1 pt-8"}>
      ...
      <div className="container space-x-4 text-center grid grid-cols-1 lg:grid-cols-2 p-4 place-items-center lg:mx-auto">
          <Image src="/assets/ir21/circles-pic.png" alt="The Image"/>
          <p className={"text-28 lg:text-38 pt-8"}>
      ...
      <div className="md:max-w-screen-md space-y-4 text-center grid grid-cols-1 p-4 place-items-center lg:mx-auto">
        <h2 className={"flex flex-row items-center"}>
          <Link href={"/impact-reports/joy/financials"}>
            <a className={"text-lg lg:text-28"}>
      ...
      <h2 className={"text-center pt-8 pb-4 text-38 lg:text-50"}>Our Mission</h2>
      <div className="container text-center grid grid-cols-1 md:grid-cols-2 gap-4 p-2 mx-auto">
          <TextBlock>
            <h3 className={"py-2 text-28 lg:text-38"}>CU Foundation</h3>
          ...
          <TextBlock>
            <h3 className={"py-2 text-28 lg:text-38"}>CU Advancement</h3>
