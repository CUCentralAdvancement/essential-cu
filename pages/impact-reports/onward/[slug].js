    ...
    <>
      ...
      <Layout>
        <div className="container">
          ...
          {/* {story.images.map((el) => {
            return (
              <div className="container story-image-container" key={el.url}>
                <img
                  src={el.url}
                  alt={el.alt}
                  height={el.height}
                ...
                <li key={el.slug} className="storycard">
                  ...
                  >
                    <a
                      className={
                        "storycard-link " +
                        (el.interest_tag ? el.interest_tag.toLowerCase() : "")
                      }
                    >
                      <img
                      ...
                      <span className="storycard-readmore">
                        <span className="storycard-readmore-text label-text">
                          Read More
                        </span>
                      </span>
                      <span className="storycard-arrow"></span>
                      <span className="storycard-temptags">
                        {`Campus Tag: ${el.campus_tag}`}
                        <br />
                        {`Interest Tag: ${el.interest_tag}`}
                        <br />
